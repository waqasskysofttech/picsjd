...
<div class="main-sec">
            <div class="main-wrapper">
                ...
                <div class="user-wrapper">
                    <form id="add-record-form" action="{{route('admin.savenews')}}" enctype="multipart/form-data" method="POST" class="main-form mc-b-3">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>Title*:</label>
                                    <input type="text" name="name" id="name" value="{{$news->title}}" required class="form-control" placeholder="Enter Title">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    <label>Slug*:</label>
                                    <input type="text" name="slug" id="slug" value="{{$news->slug}}" required class="form-control" placeholder="Enter Slug">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    <label>Short Description:</label>
                                    <textarea rows="5" class="form-control ckeditor" id="editor1"  placeholder="Enter Short Description">{{$news->short_desc}}</textarea>
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control ckeditor" id="editor2"  placeholder="Enter Long Description">{{$news->long_desc}}</textarea>
                        ...
                        <div class="col-lg-12 text-center">
                            <div class="img-upload-wrapper  mc-b-3">
                              ...
                              <figure><img src="{{asset($news->thumbnail->img_path)}}" class="thumbnail-img" alt="user-img"></figure>
                           ...
                           <div class="col-lg-12 text-center">
                            <div class="img-upload-wrapper  mc-b-3">
                            <h3>Main Image</h3>
                              <figure><img src="{{asset($news->picture->img_path)}}" class="picture" alt="user-img"></figure>
                              <label for="picture" class="user-img-btn"><i class="fa fa-camera"></i></label>
                              <input type="file"  onchange="mainpic(this);" name="pictures" id="picture" class="d-none"  accept="image/jpeg, image/png">
