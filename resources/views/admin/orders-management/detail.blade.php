        ...
        <div class="user-wrapper">   
                <div class="invoice">
                    <div class="row">
                        ...
                        <a href="{{route('admin.paystatus',$orders->id)}}" type="submit" class="alert alert-danger">Marks as Unpaid</a>
                        @else
                        <a href="{{route('admin.paystatus',$orders->id)}}" type="submit" class="alert alert-success">Marks as Paid</a>
                        @endif
