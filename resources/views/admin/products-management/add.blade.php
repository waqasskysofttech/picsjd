                ...
                <div class="row align-items-center mc-b-3">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="primary-heading color-dark">
                            <h2>Add Featured Photography</h2>
                        </div>
                    </div>
                    ...
                    <form id="add-record-form"   class="main-form mc-b-3">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="form-group">
                                    <label>Sku*:</label>
                                    <input type="text" name="sku" id="sku" value="{{old('sku')}}" min="1" required class="form-control" placeholder="Enter Sku in Inches">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-4">
                                <div class="form-group">
                                    <label>Sale Price ($)*:</label>
                                    <input type="number" name="sale_price" id="sale_price" value="{{old('sale_price')}}" min="1" required class="form-control" placeholder="Enter Sale Price in Inches">
                                </div>
                            </div>
              ...
              <div class="form-group">
                ...
                <ul class="list-inline">
                  <li class="list-inline-item">
                    <div class="checkbox">
                      <input type="radio" id="user1" name="is_featured" value="1">
                      <label for="user1">Active</label>
                    </div>
                  </li>
                  <li class="list-inline-item">
                    <div class="checkbox">
                      <input type="radio" id="user2" name="is_featured" value="0" >
